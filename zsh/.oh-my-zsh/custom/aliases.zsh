...
#Ollama
alias gemma="ollama list &>/dev/null || (ollama serve &>/dev/null & until ollama list &>/dev/null; do sleep 0.5; done); ollama run gemma4:latest"
